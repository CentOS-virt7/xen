...
%changelog
* Wed Apr 25 2018 Kevin Stange <kevin@steadfast.net> 4.6.6-11
- Import XSA 258 and 259

* Thu Mar 01 2018 Kevin Stange <kevin@steadfast.net> 4.6.6-10.el6.centos
- Import XSA 252 and 255
- Import XSA 235 (ARM only) required for XSA 255 to apply cleanly

* Wed Jan 17 2018 George Dunlap <george.dunlap@citrix.com> 4.6.6-9.el6.centos
- Import Meltdown "bandaid" (XSA-254 XPTI stage 1)

* Tue Dec 12 2017 George Dunlap <george.dunlap@citrix.com> 4.6.6-8.el6.centos
- Import update to XSA 240
- Import XSAs 248 through 251

* Tue Nov 28 2017 George Dunlap <george.dunlap@citrix.com> 4.6.6-7.el6.centos
- Import XSAs 246 and 247

* Fri Nov 17 2017 George Dunlap <george.dunlap@citrix.com> 4.6.6-6.el6.centos
- Import updates to XSA-240 and XSA-243

* Wed Oct 25 2017 George Dunlap <george.dunlap@citrix.com> 4.6.6-5.el6.centos
- Import XSA 236

* Thu Oct 12 2017 George Dunlap <george.dunlap@citrix.com> 4.6.6-4.el6.centos
- Import XSAs 237-244

* Tue Sep 12 2017 George Dunlap <george.dunlap@citrix.com> 4.6.6-3.el6.centos
- Import XSAs 231, 232, 233, 234

* Wed Aug 23 2017 George Dunlap <george.dunlap@citrix.com> 4.6.6-2.el6.centos
- Import XSAs 226, 227, 228, and 230

* Wed Aug 23 2017 George Dunlap <george.dunlap@citrix.com> 4.6.6-1.el6.centos
- Update to Xen 4.6.6

* Mon Jun 19 2017 George Dunlap <george.dunlap@citrix.com> 4.6.5-2.el6.centos
- Import XSA-220

* Mon Jun 19 2017 George Dunlap <george.dunlap@citrix.com> 4.6.5-1.el6.centos
- Update to Xen 4.6.5
...
* Tue May  2 2017 George Dunlap <george.dunlap@citrix.com> 4.6.3-13.el6.centos
- Gratuitious version bump to re-build with SeaBIOS 1.10

* Tue Apr  4 2017 George Dunlap <george.dunlap@citrix.com> 4.6.3-12.el6.centos
- Import XSA 212

* Tue Apr  4 2017 George Dunlap <george.dunlap@citrix.com> 4.6.3-11.el6.centos
- Update XSA 206 to v9

* Tue Mar 28 2017 George Dunlap <george.dunlap@citrix.com> 4.6.3-10.el6.centos
- Import XSA 206
